...
urlpatterns = [
    ...
    path('add/uploadFile/success', views.upload_file_success,
    ...
    path('add/flightHour/success', views.add_flight_hour_suceess,
         name="add_flight_hour_suceess"),
    path('add/flightHour/exist', views.add_flight_hour_exist,
         name="add_flight_hour_exist"),
    path('add/trainHour/success', views.add_train_hour_suceess,
         name="add_train_hour_suceess"),
    path('add/trainHour/exist', views.add_train_hour_exist,
         name="add_train_hour_exist"),
    ...
    path('staff/18-months/', views.prosopiko_dekaotaminou,
         name="prosopiko_dekaotaminou"),
